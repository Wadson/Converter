...
namespace Converter
{
    public partial class FrmConverter : KryptonForm
    {
        ...
        private void btnConverter_Click(object sender, EventArgs e)
        {
            ...
            lblProgress.Text = "0%"; // Inicializa a lblProgress com 0%
            ...
            worker.ProgressChanged += (s, ev) =>
            {
                ...
                lblProgress.Text = $"{(ev.ProgressPercentage * 100 / videoPaths.Count)}%"; // Atualiza a lblProgress com a porcentagem.
            ...
            worker.RunWorkerCompleted += (s, ev) =>
            {
                ...
                lblProgress.Text = "100%"; // Define 100% na lblProgress ao final da conversão.
                ToggleControls(true);
            };
